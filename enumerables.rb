...
def spiciest_foods(spicy_foods)
  # your code here
    spicy_foods.filter do |spicy_foods|
      spicy_foods[:heat_level]>5
    end
end
...
def sort_by_heat(spicy_foods)
  # your code here
  spicy_foods.sort do |spicy_foods1 ,spicy_foods2|
    spicy_foods1[:heat_level]<=>spicy_foods2[:heat_level]
  end
...
def average_heat_level(spicy_foods)
  # your code here
  total=spicy_foods.sum do |spicy_foods|
    spicy_foods[:heat_level]
  end
  total/3
end
